...
import frappe
from frappe import _, scrub, whitelist
...
class Analytics(object):
	def __init__(self, filters=None):
		...
		self.date_field = 'transaction_date' \
			if self.filters.doc_type in ['Sales Order','Quotation', 'Purchase Order'] else 'posting_date'
	...
	def get_columns(self):
		...
		if self.filters.tree_type in ["User","Customer", "Supplier", "Item"]:
			self.columns.append({
	...
	def get_data(self):
		if self.filters.tree_type in ["User","Customer", "Supplier"]:
			self.get_sales_transactions_based_on_users_or_customers_or_suppliers()
			self.get_rows()
	...
	def get_sales_transactions_based_on_users_or_customers_or_suppliers(self):
		if self.filters["value_quantity"] == 'Value':
			value_field = "base_net_total as value_field"
		else:
			value_field = "total_qty as value_field"
	
		if self.filters.tree_type == 'User':
			if self.filters.doc_type != 'Sales Invoice':
				entity = "account_manager_email as entity"
				entity_name = "account_manager_name as entity_name"
			else:
